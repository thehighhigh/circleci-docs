...
* **Rich code navigation through “go-to-definition” and “go-to-reference” commands.**: verify the definition of custom jobs or orbs, executors parameters, or in turn view where any of them are referenced in the file. 
